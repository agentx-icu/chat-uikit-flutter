...
class TencentCloudChatSearchResultBox extends StatefulWidget {
  ...
  const TencentCloudChatSearchResultBox({
    Key? key,
    required this.title,
  ...
  @override
  State<TencentCloudChatSearchResultBox> createState() =>
      _TencentCloudChatSearchResultBoxState();
}

class _TencentCloudChatSearchResultBoxState
    extends State<TencentCloudChatSearchResultBox> {
      ...
      build: (context, colorTheme, textStyle) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(color: colorTheme.dividerColor.withOpacity(0.8)),
            Column(
              children: [
                ...widget.resultList
                    .getRange(
                      0,
                      min(widget.resultList.length, _resultListRenderCount),
                    )
                    .map((e) {
